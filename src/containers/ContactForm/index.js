...
class Contact extends Component{
    ...
    render() {
      window.console.log('MainContactProps: ', this.props)
    const formStyle = {
      display: 'flex',
      flex: 1,
    ...
    return (
      <div style={{width: '100%', height: '100%', paddingTop: 75, textAlign: 'center'}}>
        Request a callback for a free, personalized quote for your project
        <div style={{minHeight: '70%', height: '85%', maxHeight: '90%', width: '100%', paddingTop: '4vmin', textAlign: 'initial'}}>

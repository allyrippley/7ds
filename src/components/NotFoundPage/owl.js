...
const NotFoundPage = () => {
  return (
    <div style={{ paddingTop: 70, display: 'flex', justifyContent: 'space-around', alignItems: 'center' }}>
      <div style={{margin: 'auto 0', alignSelf: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', height: '100%'}}>
